...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admiin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-user-alt mr-2"></i> Profile Details
  ...
  <footer class="main-footer">
    Made with <i class="fas fa-heart"></i> by <strong>Edwin Ashie</strong>. &copy;
    <script>
